...
private slots:
    ...
    QString BuyBEPAY(QString OrderType, double Quantity, double Rate);
    QString SellBEPAY(QString OrderType, double Quantity, double Rate);
